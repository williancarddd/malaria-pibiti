...
# File variables
ROOT = 'H:/My Drive/Doutorado/BaseColuna/pyradiomics/'
PARAMS = os.path.join(ROOT, 'Params.yaml')  # Parameter file
LOG = os.path.join(ROOT,  'log.txt')  # Location of output log file
INPUTCSV = os.path.join(ROOT, 'NewCases.csv')
OUTPUTCSV = os.path.join(ROOT, 'FeaturesNewCases.csv')
