...
##Variaveis globais
save_metrics_path = "C:/malaria/Jonathan/PlasmodiumAnalysis/Metrics/csvs/"
save_csvs_path = "C:/malaria/Jonathan/PlasmodiumAnalysis/Metrics/csvs/"
save_nets_path = "C:/malaria/Jonathan/PlasmodiumAnalysis/Metrics/nets/"
base_path_parts = "C:/malaria/Jonathan/PlasmodiumAnalysis/Partitions/"
...
def load_dataset(partition):
    ...
    TrainImages = [select_image(p) for p in TrainImages]
    ...
    lb = LabelBinarizer()
    TrainLabels = to_categorical( np.array(TrainLabels), num_classes=2)
    TestLabels  = to_categorical( np.array(TestLabels ), num_classes=2)
