...
if __name__ == '__main__':
  ...
  denseNum = configMain.get_dense_num()[0]
  dropOutNum = configMain.get_drop_out()[0]
  freezePercentege = configMain.get_freeze_percentage()[0]
        ...
        try:
          with tf.device('/device:GPU:0'):
            history_net = initModel.fit(train_under_X,
                                    ...
                                    callbacks=[early, checkpoint , tensorboard_callback, lr_reduce, csv_logger])
        except Exception as e:
