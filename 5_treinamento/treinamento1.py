...
save_folder = 'Metrics100'
save_metrics_path = path_project / "6_resultados" / save_folder
save_csvs_path = save_metrics_path / 'csvs'
save_nets_path = save_metrics_path / 'nets'
base_path_parts = path_project / '1_entrada' / 'partitions' / 'partitions100'
...
def load_dataset(partition):
    ...
    fName = base_path_parts / partition
